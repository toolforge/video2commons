...
( function ( $ ) {
	...
	const languageOptions = [
		...
		{ label: 'Traditional Chinese, Taiwan (zh-Hant-TW)', category: 'Videos in Traditional Chinese (Taiwan)' },
		...
		{ label: 'Serbian Cyrillic (sr-Cyrl)', category: 'Videos in Serbian Cyrillic' },
