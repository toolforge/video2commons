...
window.labels = {
	...
	notesplaylists    :"Playlists will not be processed correctly. Some sites (such as Youku and Comedy Central) make use of multipart videos, interpreted as playlists, and will not be processed correctly either.",
	...
	notesown          :'What if I need to convert and upload a file on my computer? Well, while NFS and Grid engine are still available in Tool Labs, you can use {{#a}}#vc|videoconvert{{/a}} tool.',
	noteslicensing    :'Only upload {{#a}}#fl|freely licensed{{/a}} or {{#a}}#pd|public domain{{/a}} content. {{#a}}#fu|Fair use{{/a}} is not allowed on commons.',
